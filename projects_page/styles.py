...
div[data-baseweb="tooltip"]{
  font-family: "Space Grotesk","DM Sans",ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,Arial !important;
...
/* Custom metric info badges (used in dashboard cards / chart headings). */
.info-badge[data-tip]{
  position: relative;
  outline: none;
}
